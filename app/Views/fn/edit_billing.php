<!-- <?php var_dump($data); ?> -->
<form method="post" action="<?= base_url('finance/edit_billing') . '/' . $data[0]['id'] ?>">
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-3">
            ...
            <input type="text" id="document_id" class="form-control" name="document_id" value="<?= $data[0]['document_id'] ? $data[0]['document_id'] : '' ?>" readonly required />
        </div>
        <div class="col-md-3">
