...
<div id="all" class="tabcontent" style="padding-top: 0; display:block;">
    ...
    <form method="post" action="<?= base_url('supplies/borrow') ?>">
        <div class="row" style="margin-bottom: 1%;">
            ...
            <div class="col-md-3">
                ...
                <input type="text" id="date_return" class="datetimepicker2 form-control" name="date_return" value="<?= $_POST['date_return'] ? $_POST['date_return'] : '' ?>" required>
            </div>
            <div class="col-md-6">
        ...
        <div class="row" style="margin-bottom: 1%;">
            ...
            <div class="col-md-6">
                ...
                <select class="form-control" name="status" id="status">
                    ...
                    <option value="1">ยืมพัสดุ</option>
