<form method="post" action="<?= base_url('finance/overdue') ?>">
    ...
    <div class="row" style="margin-bottom: 1%;">
        ...
        <div class="col-md-4">
            ...
            <input type="number" id="telephone"  maxlength="10" class="form-control" name="telephone" value="<?= $_POST['telephone'] ? $_POST['telephone'] : '' ?>" pattern="[0-9]{10}" />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="type_id" id="type_id" required>
                ...
                <option value="1" <?php $_POST['type_id'] == 1 ? print 'selected' : ''; ?>>ค้างชำระ</option>
                <option value="2" <?php $_POST['type_id'] == 2 ? print 'selected' : ''; ?>>ชำระแล้ว</option>
            </select>
        </div>
        <div class="col-md-3">
