                ...
                <?php foreach ($data as $x) : ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="textright"><?php echo number_format($x['allocate_year_amount'], 2); ?></td>
                            <td class="textright"><?php echo number_format($x['request_year_amount'], 2); ?></td>
                            <td class="textright"><?php echo number_format($x['estimate_year1_amount'], 2); ?></td>
                            <td class="textright"><?php echo number_format($x['estimate_year2_amount'], 2); ?></td>
                            <td class="textright"><?php echo number_format($x['estimate_year3_amount'], 2); ?></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#project').change(function() {
            value = $(this).val();
            link = "http://chapanakit.airtimes.co/account/cost_estimate/" + value;
