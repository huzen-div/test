<form method="post" action="<?= base_url('hire/edit_hire') . '/' . $data[0]['id']  ?>" enctype="multipart/form-data">
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            <label for="operator">ผู้รับผิดชอบ</label>
            <input type="text" id="operator" class="form-control" name="operator" value="<?= $data[0]['operator'] ? $data[0]['operator'] : '' ?>" required />
        </div>
        <div class="col-md-6">
            <label for="employer">ผู้ว่าจ้าง</label>
            <input type="text" id="employer" class="form-control" name="employer" value="<?= $data[0]['employer'] ? $data[0]['employer'] : '' ?>" required />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            <label for="contractor">ผู้รับจ้าง</label>
            <input type="text" id="contractor" class="form-control" name="contractor" value="<?= $data[0]['contractor'] ? $data[0]['contractor'] : '' ?>" required />
        </div>
        <div class="col-md-6">
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4">
            <label for="contract">รูปแบบ</label>
        ...
        <div class="col-md-4">
            <label for="document">เอกสารแนบ <?php if ($data[0]['document'] != null) { ?><a href="<?php echo base_url('files/hire_files') . '/' . $data[0]['document']; ?>">ไฟล์</a> <?php } ?></label> <span style="color: #25BCF5;text-decoration: underline;cursor: pointer;" id="del_document"><i class="fas fa-minus-circle"></i></span>
    ...
    <div class="row" style="margin-bottom: 1%;">
        ...
        <div class="col-md-4">
            <label for="document2">เอกสารแนบ2 <?php if ($data[0]['document2'] != null) { ?><a href="<?php echo base_url('files/hire_files') . '/' . $data[0]['document2']; ?>">ไฟล์</a> <?php } ?></label> <span style="color: #25BCF5;text-decoration: underline;cursor: pointer;" id="del_document2"><i class="fas fa-minus-circle"></i></span>
            <input type='file' class="form-control" id="document2" name="document2" />
        </div>
        <div class="col-md-4">
            <label for="document3">เอกสารแนบ3 <?php if ($data[0]['document3'] != null) { ?><a href="<?php echo base_url('files/hire_files') . '/' . $data[0]['document3']; ?>">ไฟล์</a> <?php } ?> </label> <span style="color: #25BCF5;text-decoration: underline;cursor: pointer;" id="del_document3"><i class="fas fa-minus-circle"></i></span>
