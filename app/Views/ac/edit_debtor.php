<form method="post" action="<?= base_url('account/edit_debtor') . '/' . $data[0]['id'] ?>" enctype="multipart/form-data">
    <h2>ข้อมูลสมาชิก</h2>
    ...
    <div class="row" style="margin-bottom: 1%;">
        ...
        <div class="col-md-6">
            ...
            <!-- <input type="text" id="gender" class="form-control" name="gender" value="<?= $data[0]['gender'] ? $data[0]['gender'] : '' ?>" required/> -->
            <input type="radio" id="male" name="gender" value="ผู้ชาย" required <?php $data[0]['gender'] == 'ผู้ชาย' ? print 'checked' : ''; ?>>
            <label for="male">ผู้ชาย</label>
            <input type="radio" id="female" name="gender" value="ผู้หญิง" <?php $data[0]['gender'] == 'ผู้หญิง' ? print 'checked' : ''; ?>>
            <label for="female">ผู้หญิง</label>
            <input type="radio" id="Other" name="gender" value="อื่นๆ" <?php $data[0]['gender'] == 'อื่นๆ' ? print 'checked' : ''; ?>>
    ...
    <div class="row" style="margin-bottom: 1%;">
        ...
        <div class="col-md-6">
            ...
            <input type="text" id="telephone" class="form-control" name="telephone" value="<?= $data[0]['telephone'] ? $data[0]['telephone'] : '' ?>" pattern="[0-9]{10}" placeholder="xxxxxxxxxx"/>
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4">
            ...
            <font >
                ...
                <input type="radio" id="มีชีวิต" name="alive" value="มีชีวิต"  required <?php $data[0]['alive'] == 'มีชีวิต' ? print 'checked' : ''; ?>>
                <label for="มีชีวิต">มีชีวิต</label>
                <input type="radio" id="เสียชีวิต" name="alive" value="เสียชีวิต" <?php $data[0]['alive'] == 'เสียชีวิต' ? print 'checked' : ''; ?>>
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4">
            ...
            <input type="text" id="follower_name" class="form-control" name="follower_name" value="<?= $data[0]['follower_name'] ? $data[0]['follower_name'] : '' ?>" required />
        </div>
        <div class="col-md-4">
            <label for="follower_date">วัน/เดือน/ปีเกิด <font >สมาชิกมีอายุ (<span id="age2"></span>)</font></label>
            <!-- <input type="date" id="date" class="form-control" name="date" value="<?= $data[0]['date'] ? $data[0]['date'] : '' ?>" required /> -->
            <input type="text" id="follower_date" class="datetimepicker2 form-control findage2" name="follower_date" value="<?= $data[0]['follower_date'] ? $data[0]['follower_date'] : '' ?>" required>
        </div>
        <div class="col-md-4">
            <label for="follower_image">รูปทายาท</label>
            <input type='file' class="form-control" id="follower_image" accept="image/*" name="follower_image"  />

            <img id="preview_follower_image" class="img-fluid" src="<?= base_url('files') . '/' . $data[0]['follower_image'] ?>" alt="your image" style="margin: 1%;width: 100px;" />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            <label for="follower_taxpayer_number">เลขที่บัตรประชาชน</label>
            <input type="number" id="follower_taxpayer_number" class="form-control" name="follower_taxpayer_number" value="<?= $data[0]['follower_taxpayer_number'] ? $data[0]['follower_taxpayer_number'] : '' ?>" required />
        </div>
        <div class="col-md-6">
            <label for="follower_relationship">ความสัมพันธ์กับสมาชิก</label>
            <input type="text" id="follower_relationship" class="form-control" name="follower_relationship" value="<?= $data[0]['follower_relationship'] ? $data[0]['follower_relationship'] : '' ?>" required />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-12">
            ...
            <!-- <input type="text" id="address" class="form-control" name="address" value="<?= $data[0]['address'] ? $data[0]['address'] : '' ?>"/> -->
            <textarea class="form-control" rows="1" name="follower_address" id="follower_address"><?= $data[0]['follower_address'] ?? $data[0]['follower_address']  ?></textarea>
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            ...
            <input type="email" id="follower_email" class="form-control" name="follower_email" value="<?= $data[0]['follower_email'] ? $data[0]['follower_email'] : '' ?>" />
        </div>
        <div class="col-md-6">
            <label for="follower_telephone">เบอร์โทร</label>
            <input type="text" id="follower_telephone" class="form-control" name="follower_telephone" value="<?= $data[0]['follower_telephone'] ? $data[0]['follower_telephone'] : '' ?>" pattern="[0-9]{10}" placeholder="xxxxxxxxxx"/>
        </div>
    </div>
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            ...
            <input type="text" id="follower_account_number" class="form-control" name="follower_account_number" value="<?= $data[0]['follower_account_number'] ? $data[0]['follower_account_number'] : '' ?>" required  pattern="\d{10}|\d{13}" placeholder="10 ตัว หรือ 13 ตัว"/>
        </div>
        <div class="col-md-6">
            <label for="follower_account_name">ชื่อธนาคาร</label>
            <input type="text" id="follower_account_name" class="form-control" name="follower_account_name" value="<?= $data[0]['follower_account_name'] ? $data[0]['follower_account_name'] : '' ?>" />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            ...
            <!-- <select class="form-control " name="follower_account_type" id="follower_account_type" required>
                ...
                <option value="1" <?php $data[0]['follower_account_type'] == 1 ? print 'selected' : ''; ?>>test</option>
            </select> -->
            <input type="text" id="follower_account_type" class="form-control" name="follower_account_type" value="<?= $data[0]['follower_account_type'] ? $data[0]['follower_account_type'] : '' ?>" />
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4">
            ...
            <input type="text" id="follower_account_branch" class="form-control" name="branch" value="<?= $data[0]['branch'] ? $data[0]['branch'] : '' ?>" />
        </div>
    </div>
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            ...
            <input type="text" id="emergency_name" class="form-control" name="emergency_name" value="<?= $data[0]['emergency_name'] ? $data[0]['emergency_name'] : '' ?>" required />
        </div>
        <div class="col-md-6">
            <label for="emergency_date">วัน/เดือน/ปีเกิด <font >สมาชิกมีอายุ (<span id="age3"></span>)</font></label>
            <!-- <input type="date" id="date" class="form-control" name="date" value="<?= $data[0]['date'] ? $data[0]['date'] : '' ?>" required /> -->
            <input type="text" id="emergency_date" class="datetimepicker2 form-control findage3" name="emergency_date" value="<?= $data[0]['emergency_date'] ? $data[0]['emergency_date'] : '' ?>" required>
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            <label for="emergency_taxpayer_number">เลขที่บัตรประชาชน</label>
            <input type="number" id="emergency_taxpayer_number" class="form-control" name="emergency_taxpayer_number" value="<?= $data[0]['emergency_taxpayer_number'] ? $data[0]['emergency_taxpayer_number'] : '' ?>" required />
        </div>
        <div class="col-md-6">
            <label for="relationship">ความสัมพันธ์กับสมาชิก</label>
            <input type="text" id="relationship" class="form-control" name="relationship" value="<?= $data[0]['relationship'] ? $data[0]['relationship'] : '' ?>" required />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-12">
            ...
            <!-- <input type="text" id="address" class="form-control" name="address" value="<?= $data[0]['address'] ? $data[0]['address'] : '' ?>"/> -->
            <textarea class="form-control" rows="1" name="emergency_address" id="emergency_address"><?= $data[0]['emergency_address'] ?? $data[0]['emergency_address']  ?></textarea>
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            ...
            <input type="email" id="emergency_email" class="form-control" name="emergency_email" value="<?= $data[0]['emergency_email'] ? $data[0]['emergency_email'] : '' ?>" />
        </div>
        <div class="col-md-6">
            <label for="emergency_telephone">เบอร์โทร</label>
            <input type="text" id="emergency_telephone" class="form-control" name="emergency_telephone" value="<?= $data[0]['emergency_telephone'] ? $data[0]['emergency_telephone'] : '' ?>" pattern="[0-9]{10}"  placeholder="xxxxxxxxxx"/>
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            <label for="emergency_account_number">เลขที่บัญชีธนาคาร</label>
            <input type="text" id="emergency_account_number" class="form-control" name="emergency_account_number" value="<?= $data[0]['emergency_account_number'] ? $data[0]['emergency_account_number'] : '' ?>" required  pattern="\d{10}|\d{13}" placeholder="10 ตัว หรือ 13 ตัว"/>
        </div>
        <div class="col-md-6">
            <label for="emergency_account_name">ชื่อธนาคาร</label>
            <input type="text" id="emergency_account_name" class="form-control" name="emergency_account_name" value="<?= $data[0]['emergency_account_name'] ? $data[0]['emergency_account_name'] : '' ?>" />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-6">
            ...
            <!-- <select class="form-control " name="emergency_account_type" id="emergency_account_type" required>
                <option selected value="">เลือกประเภทบัญชี</option>
                <option value="1" <?php $data[0]['emergency_account_type'] == 1 ? print 'selected' : ''; ?>>test</option>
            </select> -->
            <input type="text" id="emergency_account_type" class="form-control" name="emergency_account_type" value="<?= $data[0]['emergency_account_type'] ? $data[0]['emergency_account_type'] : '' ?>" />
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4">
            <label for="branch">สาขา</label>
            <input type="text" id="emergency_account_branch" class="form-control" name="emergency_account_branch" value="<?= $data[0]['emergency_account_branch'] ? $data[0]['emergency_account_branch'] : '' ?>" />
        </div>
    </div>
    <!-- <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4">
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4 offset-md-8">
            ...
            <input type="text" id="prepaid_checks" class="form-control" name="prepaid_checks" value="<?= $data[0]['prepaid_checks'] ? $data[0]['prepaid_checks'] : '' ?>" />
        </div>
    </div> -->
    <div class="row">
