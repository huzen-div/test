...
<div id="all" class="tabcontent" style="padding-top: 0; display:block;">
    ...
    <form method="post" action="<?= base_url('setting/tax_rate') ?>">
        <div class="row" style="margin-bottom: 1%;">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="code" class="form-control" name="code" value="<?= $_POST['code'] ? $_POST['code'] : '' ?>" required />
            </div>
        </div>
        <div class="row" style="margin-bottom: 1%;">
            <div class="col-md-6">
                <label for="tax_rate">อัตราภาษี</label>
                <input type="text" id="tax_rate" class="form-control money" name="tax_rate" value="<?= $_POST['tax_rate'] ? $_POST['tax_rate'] : 0 ?>" required />
            </div>
            <div class="col-md-6">
