<form method="post" action="<?= base_url('finance/deposit') ?>">
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4">
            <label for="depositor">ผู้นำฝาก</label>
            <input type="text" id="depositor" class="form-control" name="depositor" value="<?= $_POST['depositor'] ? $_POST['depositor'] : '' ?>" required />
        </div>
        <div class="col-md-4">
    ...
    <div class="row" style="margin-bottom: 1%;">
        ...
        <div class="col-md-4">
            ...
            <input type="text" id="deposit_items" class="form-control" name="deposit_items" value="<?= $_POST['deposit_items'] ? $_POST['deposit_items'] : '' ?>" required />
        </div>
        <div class="col-md-4">
