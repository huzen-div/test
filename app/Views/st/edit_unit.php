...
<div id="all" class="tabcontent" style="padding-top: 0; display:block;">
    ...
    <form method="post" action="<?= base_url('setting/edit_unit') . '/' . $data[0]['id']  ?>">
        <div class="row" style="margin-bottom: 1%;">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="unit_name" class="form-control" name="unit_name" value="<?= $data[0]['unit_name'] ? $data[0]['unit_name'] : '' ?>" required />
            </div>
        </div>
        <!-- <div class="row" style="margin-bottom: 1%;">
            <div class="col-md-6">
                ...
                <select class="form-control select2" name="unit_base" id="unit_base">
                    ...
                    <?php foreach ($unit as $row) { ?>
                        <option value="<?= $row['id'] ?>" <?php $data[0]['unit_base'] == $row['id'] ? print 'selected' : ''; ?>><?= $row['unit_name'] . ' (' . $row['unit_code'] . ')' ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="col-md-6" id="operater_div">
                ...
                <select class="form-control" name="operater" id="operater" >
                    ...
                    <option value="1" <?php $data[0]['operater'] == 1 ? print 'selected' : ''; ?>>คูณ (*)</option>
                    <option value="2" <?php $data[0]['operater'] == 2 ? print 'selected' : ''; ?>>หาร (/)</option>
                    <option value="3" <?php $data[0]['operater'] == 3 ? print 'selected' : ''; ?>>บวก (+)</option>
                    <option value="4" <?php $data[0]['operater'] == 4 ? print 'selected' : ''; ?>>ลบ (-)</option>
                </select>
            </div>
            <div class="col-md-6" id="operater_value_div">
                <label for="operater_value">การดำเนินการ</label>
                <input type="text" id="operater_value" class="form-control" name="operater_value" value="<?= $data[0]['operater_value'] ? $data[0]['operater_value'] : '' ?>" />
            </div>
        </div> -->
        <div class="row">
