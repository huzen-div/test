<form method="post" action="<?= base_url('finance/payoffdebt') ?>">
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-3">
            ...
            <select class="form-control select2" name="customer_id" id="customer_id" required>
                <option selected value="">---กรุณาเลือกรหัสสมาชิก---</option>
    ...
    <div class="row" style="margin-bottom: 1%;">
        ...
        <div class="col-md-4">
            ...
            <input type="text" id="telephone" maxlength="10" class="form-control" name="telephone" value="<?= $_POST['telephone'] ? $_POST['telephone'] : '' ?>" pattern="[0-9]{10}" />
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <select class="form-control" name="add_debt_id" id="add_debt_id" required>
                ...
                <option value="4">จ่ายเงินทายาทสมาชิก</option>
            </select>
        </div>
        <div class="col-md-3">
            ...
            <select class="form-control" name="type_id" id="type_id" required>
                ...
                <option value="4">ระหว่างชำระ</option>
    ...
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4 offset-md-8">
            ...
            <input type="number" id="amount" class="form-control vat" name="amount" value="<?= $_POST['amount'] ? $_POST['amount'] : '' ?>" required/>
        </div>
    </div>
    <div class="row" style="margin-bottom: 1%;">
        <div class="col-md-4 offset-md-8">
