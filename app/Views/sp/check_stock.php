...
<div id="all" class="tabcontent" style="padding-top: 0; display:block;">
    ...
    <form method="post" action="<?= base_url('supplies/check_stock') ?>">
        ...
        <div class="row" style="margin-bottom: 1%;">
            <div class="col-md-6">
                ...
                <input type="radio" id="full" name="type" value="1" required <?php $_POST['type'] == 1 ? print 'checked' : ''; ?>>
                <label for="full" style="margin-right: 5%;">Full</label>
                <input type="radio" id="some" name="type" value="2" <?php $_POST['type'] == 2 ? print 'checked' : ''; ?>>
