...
<div id="all" class="tabcontent" style="padding-top: 0; display:block;">
    ...
    <form method="post" action="<?= base_url('hire/hire') ?>" enctype="multipart/form-data">
        <div class="row" style="margin-bottom: 1%;">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="employer" class="form-control" name="employer" value="<?= $_POST['employer'] ? $_POST['employer'] : '' ?>" required />
            </div>
        </div>
        <div class="row" style="margin-bottom: 1%;">
            <div class="col-md-6">
                <label for="contractor">ผู้รับจ้าง</label>
                <input type="text" id="contractor" class="form-control" name="contractor" value="<?= $_POST['contractor'] ? $_POST['contractor'] : '' ?>" required />
            </div>
            <div class="col-md-6">
