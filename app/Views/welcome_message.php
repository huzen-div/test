...
<body>
	<form method="post" action="<?= base_url('home/index') ?>">
		...
		<tr>
				<td width="230">Enter No ID </td>
				<td width="329"><input type="number" name="no"/></td>
			</tr>
			<tr>
				<td width="230">Enter Date </td>
				<td width="329"><input type="date" name="date"/></td>
			</tr>
			<tr>
				<td width="230">Enter Refer </td>
				<td width="329"><input type="text" name="refer"/></td>
			</tr>
			<tr>
				<td width="230">Enter Detail </td>
				<td width="329"><input type="text" name="detail"/></td>
			</tr>
			<tr>
				<td width="230">Enter Note </td>
				<td width="329"><input type="text" name="note"/></td>
			</tr>
			<tr>
				<td width="230">Enter Amount </td>
				<td width="329"><input type="number" name="amount"/></td>
			</tr>
			<tr>
