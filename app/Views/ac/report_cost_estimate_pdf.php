            ...
            <table width="100%" style="margin-left: auto;  margin-right: auto;" class="table">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2">โครงการหลัก</th>
                        <th rowspan="2">โครงการย่อย</th>
                        <th rowspan="2">จัดสรรปีงบประมาณ ปี <?= $x['allocate_year']; ?></th>
                        <th rowspan="2">คำขอตั้งแต่ปีงบประมาณ ปี <?= $x['request_year']; ?></th>
                        <th colspan="3">ประมาณการค่าใช้จ่ายล่วงหน้า</th>
                        <th rowspan="2">ผู้ดำเนินการ</th>
                    </tr>
                    <tr>
                ...
                <tbody style="min-height: 600px;">
                    <tr>
                        ...
                        <td><?php echo date('d/m/Y', strtotime($x['implementation_date'])); ?></td>
                        <td><?php echo $x['main_item']; ?></td>
                        <td><?php echo $x['sub_item']; ?></td>
                        <td align='right'><?php echo number_format($x[''], 2); ?></td>
                        <td align='right'><?php echo number_format($x[''], 2); ?></td>
                        <td align='right'><?php echo number_format($x[''], 2); ?></td>
                        <td align='right'><?php echo number_format($x[''], 2); ?></td>
                        <td align='right'><?php echo number_format($x[''], 2); ?></td>
                ...
                <tfoot>
                    <tr>
                        <td align='center' colspan="10" valign="top">รวม</td>
                        <!-- <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
