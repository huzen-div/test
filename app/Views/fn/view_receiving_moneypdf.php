        ...
        <?php foreach ($data as $x) : ?>
            <table width="100%">
                <tr>
                    ...
                    <td width="30%"><?php echo $x['name']; ?></td>
                    <td width="150"><strong>
                            เลขที่ :
                        </strong></td>
                ...
                <tr>
                    ...
                    <td valign="top" width="30%" rowspan="2"><?php echo date('d/m/Y', strtotime($x['bill_date'])); ?></td>
                    <td width="150"><strong>
                            วันนัดรับชำระ :
                        </strong></td>
                    <td width="30%">
                ...
                <tr>
                    ...
                    <td valign="top" width="30%"><?php echo $x['contact']; ?></td>
                </tr>
            </table>
            ...
            <table width="100%" style="margin-left: auto;  margin-right: auto;" class="table">
                ...
                <tfoot>
                    ...
                    ?>
                    <tr>
                        <td rowspan="5" colspan="2" valign="top">หมายเหตุ <?php echo $x['note']; ?></td>
                    </tr>
                    <tr height="30">
