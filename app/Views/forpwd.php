...
<body>
                ...
                <div class="row d-flex">
                    <div class="col-lg-6">
                        <div class="card1 pb-5">
                          <br>
                                                      <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="<?= base_url('logo.png'); ?>" class="image" title="สำนักงานฌาปนกิจสงเคราะห์ กระทรวงสาธารณสุข"> </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card2 card border-0 px-4 py-5">
                                                        <label class="mb-1"><h2>เข้าสู่ระบบก่อนใช้งาน</h2> <hr>
                            <div class="row px-3">
                            ...
                            <div class="row px-3 mb-4">
								...
								<a href="#" class="ml-auto mb-0 text-sm">ฉันลืมรหัสผ่าน?</a> 
 ...
 &nbsp;&nbsp;<button type="reset" class="btn btn-gray text-center">เคลียร์</button>
                ...
                <div class="bg-blue py-4">
                    <div class="row px-3"> <small class="ml-4 ml-sm-5 mb-2"><center>Copyright &copy; 2021. All rights reserved. สำนักงานฌาปนกิจสงเคราะห์ กระทรวงสาธารณสุข</center></small>
