            ...
            <tbody>
                ...
                if ($all) : ?>
                    <?php foreach ($all as $x) : ?>
                        <tr>
                            <td><?php echo $x['id']; ?>
                            <td href="<?= base_url('finance/view_import_billingid') . '/' . $x['id'] ?>" data-toggle="modal" data-remote="false" data-target="#myModal"><?php echo $x['id']; ?>
    ...
    <form method="post" action="<?= base_url('finance/import_billing') ?>">
        ...
        <table class="table display nowrap" id="dataTable2" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>
                        <div class="text-center"><input name="select_all" id="select-all2" type="checkbox" /></div>
                    </th>
                    <th>ลำดับ</th>
                    <th>Record Type</th>
                    <th>Sequence No.</th>
    ...
    <form method="post" action="<?= base_url('finance/import_billing') ?>">
        ...
        <table class="table display nowrap" id="dataTable3" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>
                        <div class="text-center"><input name="select_all" id="select-all3" type="checkbox" /></div>
                    </th>
                    <th>ลำดับ</th>
                    <th>Record Type</th>
                    <th>Sequence No.</th>
    ...
    <form method="post" action="<?= base_url('finance/import_billing') ?>">
        ...
        <table class="table display nowrap" id="dataTable4" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>
                        <div class="text-center"><input name="select_all" id="select-all4" type="checkbox" /></div>
                    </th>
                    <th>ลำดับ</th>
                    <th>Record Type</th>
                    <th>Sequence No.</th>
    ...
    <form method="post" action="<?= base_url('finance/import_billing') ?>">
        ...
        <table class="table display nowrap" id="dataTable5" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>
                        <div class="text-center"><input name="select_all" id="select-all5" type="checkbox" /></div>
                    </th>
                    <th>ลำดับ</th>
                    <th>Record Type</th>
                    <th>Sequence No.</th>
    ...
    <form method="post" action="<?= base_url('finance/import_billing') ?>">
        ...
        <table class="table display nowrap" id="dataTable6" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>
                        <div class="text-center"><input name="select_all" id="select-all6" type="checkbox" /></div>
                    </th>
                    <th>ลำดับ</th>
                    <th>Record Type</th>
                    <th>Sequence No.</th>
    ...
    $(document).ready(function() {
        ...
        var table2 = $('#dataTable2').DataTable({
            ...
            columnDefs: [{
                ...
                'searchable': false,
                'orderable': false,
                'className': 'dt-body-center table2',
                'render': checkbox
            }],
            lengthMenu: [
                [10, 25, 50, -1],
        ...
        var table3 = $('#dataTable3').DataTable({
            ...
            columnDefs: [{
                ...
                'searchable': false,
                'orderable': false,
                'className': 'dt-body-center table3',
                'render': checkbox
            }],
            lengthMenu: [
                [10, 25, 50, -1],
        ...
        var table4 = $('#dataTable4').DataTable({
            ...
            columnDefs: [{
                ...
                'searchable': false,
                'orderable': false,
                'className': 'dt-body-center table4',
                'render': checkbox
            }],
            lengthMenu: [
                [10, 25, 50, -1],
        ...
        var table5 = $('#dataTable5').DataTable({
            ...
            columnDefs: [{
                ...
                'searchable': false,
                'orderable': false,
                'className': 'dt-body-center table5',
                'render': checkbox
            }],
            lengthMenu: [
                [10, 25, 50, -1],
        ...
        var table6 = $('#dataTable6').DataTable({
            ...
            columnDefs: [{
                ...
                'searchable': false,
                'orderable': false,
                'className': 'dt-body-center table6',
                'render': checkbox
            }],
            lengthMenu: [
                [10, 25, 50, -1],
