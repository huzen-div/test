...
<div id="all" class="tabcontent" style="padding-top: 0; display:block;">
    ...
    <form method="post" action="<?= base_url('account/add_money_source') ?>" enctype="multipart/form-data">
        ...
        <div class="row" style="margin-bottom: 1%;">
            ...
            <div class="col-md-6">
                ...
                <br>
                <input type="radio" id="แสดงผล" name="show" value="1" required>
                <label for="แสดงผล" style="margin-right: 1%;">แสดงผล</label>
                <input type="radio" id="ไม่แสดงผล" name="show" value="0">
        ...
        <div class="row" style="margin-bottom: 1%;">
            ...
            <div class="col-md-6">
                ...
                <br>
                <input type="radio" id="งบขั้นตํ่า" name="budget" value="1" required>
                <label for="งบขั้นตํ่า" style="margin-right: 1%;">งบขั้นตํ่า</label>
                <input type="radio" id="งบกลาง" name="budget" value="2">
                <label for="งบกลาง" style="margin-right: 1%;">งบกลาง</label>
                <input type="radio" id="งบสูงสุด" name="budget" value="3">
